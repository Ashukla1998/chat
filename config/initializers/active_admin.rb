ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "Project Clone"
  ...
  config.on_unauthorized_access = :unauthorized_access

  config.authorization_adapter = ActiveAdmin::SimpleAuthorization

  config.before_action :authorize_user!
end
module ActiveAdmin
  class SimpleAuthorization
    def authorized?(action, subject = nil)
      case action
      when :dashboard
        user.admin? # Adjust this based on your user model and roles
